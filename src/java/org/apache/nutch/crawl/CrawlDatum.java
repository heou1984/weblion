...
public class CrawlDatum implements WritableComparable<CrawlDatum>, Cloneable {
  ...
  private String evaluateScore = "1123"+System.currentTimeMillis();
  ...
  public void write(DataOutput out) throws IOException {
    ...
    if(null != this.evaluateScore){
    	out.writeChars(this.evaluateScore);
    }
    /*
    if (evaluateScore == null) {
        out.writeByte(0);
    } else{
        out.writeByte(evaluateScore.length);
        out.write(evaluateScore);
    }
    */
  }
